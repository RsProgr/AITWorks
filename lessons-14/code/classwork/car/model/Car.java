...
public class Car {
    ...
    // fields - поля - это характеристика объекта, который есть в классе
    ...
    // геттеры = это методы, которые позволяют получить  значения полей
    // get - получить
    // сеттеры - это методы  которые позволяют установить  значения полей
    // сет - установить
